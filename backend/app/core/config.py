...
class Settings:
    ...
    # Database — uses /tmp on any cloud serverless/ephemeral platform, local path for dev
    DATABASE_URL: str = os.getenv(
        "DATABASE_URL",
        "sqlite:////tmp/app.db" if (os.getenv("RENDER") or os.getenv("VERCEL")) else "sqlite:///./app.db"
    )
